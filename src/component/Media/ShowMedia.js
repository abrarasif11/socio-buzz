...
const ShowMedia = ({ media }) => {
    ...
    console.log(media);
    return (
        <div className="max-w-lg p-4 mx-auto mb-10 mt-20 shadow-md dark:bg-gray-900 dark:text-gray-100">
            <div className="flex justify-between pb-4 border-bottom">
                <div className="flex items-center">
                    <a rel="noopener noreferrer" href="#" className="mb-0 capitalize dark:text-gray-100">{}</a>
                </div>
            ...
            <div className="space-y-4">
                ...
                <button type="button" title="Like post" className="flex items-center text-red-700 justify-center">
                ...
                <Link to='/login' rel="noopener noreferrer" className="block">
                        <h3 className="text-xl font-semibold dark:text-violet-400">See Details</h3>
                    </Link>
            </div>
        </div>
    );
